...
class Network:
    ...
    def create(self, interscalehub_NEST_TO_LFPy_address):
        ...
        if len(self.sim_dict['rec_dev']) > 0:
            self.__create_recording_devices(interscalehub_NEST_TO_LFPy_address)
    ...
    def evaluate(self, raster_plot_interval, firing_rates_interval):
        ...
        if nest.Rank() == 0:
            ...
            # TODO resolve *.dat not found erros
    ...
    def __create_recording_devices(self, interscalehub_NEST_TO_LFPy_address):
